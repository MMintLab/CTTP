...
if __name__ == '__main__':
    ...
    # import pdb; pdb.set_trace()
    bubbles_img_mean, bubbles_img_std,bubbles_img_min, bubbles_img_max, gelslim_diff_mean, gelslim_diff_std, gelslim_diff_min, gelslim_diff_max, pose_mean, pose_std, pose_min, pose_max = get_datasets_stats(datasets_train)
    ...
    print('pose_min:', pose_min)
    print('pose_max:', pose_max)
    import pdb; pdb.set_trace()
